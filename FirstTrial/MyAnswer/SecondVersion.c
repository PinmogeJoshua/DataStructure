...
bool loadBook(BookList *list, const char *filename) {
    ...
    if (!fp) {
        ...
        while (fgets(tmpstr, sizeof(tmpstr), fp)) {
            ...
            char utf8_name[256], utf8_author[256], utf8_publisher[256];
            ...
            outbytesleft = sizeof(utf8_name) - 1;
            ...
            *outbuf = '\0';
            ...
            inbuf = author;
            outbuf = utf8_author;
            inbytesleft = strlen(author);
            outbytesleft = sizeof(utf8_author) - 1;
            if (iconv(cd, &inbuf, &inbytesleft, &outbuf, &outbytesleft) == (size_t)-1) {
                perror("iconv");
                iconv_close(cd);
                fclose(fp);
            ...
            *outbuf = '\0';
            ...
            // 转换publisher
            inbuf = publisher;
            outbuf = utf8_publisher;
            inbytesleft = strlen(publisher);
            outbytesleft = sizeof(utf8_publisher) - 1;
            if (iconv(cd, &inbuf, &inbytesleft, &outbuf, &outbytesleft) == (size_t)-1) {
                perror("iconv");
                iconv_close(cd);
                fclose(fp);
            ...
            *outbuf = '\0';
            ...
            InsertBook(list, id, utf8_name, utf8_author, utf8_publisher, year, i);
        }
    }
    fclose(fp);
    return true;
